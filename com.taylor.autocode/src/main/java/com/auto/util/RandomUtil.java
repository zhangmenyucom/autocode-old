...
public class RandomUtil {
     ...
     * @param maxLength 传入数必须是正数。
     * @author taylor 2014-4-16 上午10:16:30
     */
     ...
     * @author taylor 2014-4-16 上午10:16:56
     */
     ...
     * @notes:获取大写字母的随机len
     * @param len 随机串长度
     * @author taylor 2014-4-16 上午10:22:50
     */
     ...
     * @notes:获取小写字母的随机len
     * @param len 随机串长度
     * @author taylor 2014-4-16 上午10:24:32
     */
     ...
     * @param maxLength
     * @param source
     * @author taylor 2014-4-16 上午10:18:25
     */
     ...
     * @author taylor 2014-5-12 上午10:30:40
     */
    ...
    public static void main(String[] args) {
        System.out.println(RandomUtil.getNumber(3));
        System.out.println(RandomUtil.getRegionNumber(1, 2));
        System.out.println(RandomUtil.getString(3));
        System.out.println(RandomUtil.getStringAndNumber(3));
        System.out.println(RandomUtil.getResultByCustom("xushengxiang.", 8));
        System.out.println(RandomUtil.getNumberByLength(3));
    }
}
